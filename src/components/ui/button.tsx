  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        gradient:
          "text-white shadow-glow hover:-translate-y-0.5 bg-[linear-gradient(100deg,var(--primary),var(--sky))] hover:brightness-110",
        outline:
          "border border-border bg-transparent hover:bg-muted hover:-translate-y-0.5",
        ghost: "hover:bg-muted",
        glass: "glass text-foreground hover:shadow-lift hover:-translate-y-0.5",

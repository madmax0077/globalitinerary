/**
 * Add missing top-1000 tourism cities to city-targets.json, then:
 *   node scripts/generate-cities.mjs
 *   node scripts/seed-top1000-overlays.mjs
 *   node scripts/fetch-top1000-city-images.mjs
 */
...
const list = uniqueTop1000().map((c) => ({
  ...c,

/**
 * Add missing top-3000 tourism cities to city-targets.json, then:
 *   node scripts/generate-cities.mjs
 *   $env:NODE_TLS_REJECT_UNAUTHORIZED=0; node scripts/fetch-wikivoyage-missing.mjs
 *   node scripts/generate-cities.mjs
 *   $env:NODE_TLS_REJECT_UNAUTHORIZED=0; node scripts/fetch-top3000-city-images.mjs
 *   node scripts/generate-cities.mjs
...
const list = uniqueTop3000().map((c) => ({
  ...c,

/**
 * Add missing top-2000 tourism cities to city-targets.json, then:
 *   node scripts/generate-cities.mjs
 *   $env:NODE_TLS_REJECT_UNAUTHORIZED=0; node scripts/fetch-wikivoyage-missing.mjs
 *   node scripts/generate-cities.mjs
 *   $env:NODE_TLS_REJECT_UNAUTHORIZED=0; node scripts/fetch-top2000-city-images.mjs
 */
...
const list = uniqueTop2000().map((c) => ({
  ...c,

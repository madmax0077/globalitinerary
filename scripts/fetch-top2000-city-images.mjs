...
import { TOP2000_EXTRA } from "./top2000-tourism-cities.mjs";
...
console.log("top2000 extras needing real photos:", need.length);
...
fs.writeFileSync(cityFile, before + JSON.stringify(data, null, 2) + after);
fs.writeFileSync(
  path.join(__dirname, "fetch-top2000-images-log.json"),
